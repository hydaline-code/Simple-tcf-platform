  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-semibold">Administration TCF Canada</h2>
          <p className="text-gray-600">Données stockées dans le cloud Firebase</p>
        </div>
        <div className="flex gap-2">
          <Button 
            variant="outline" 
      ...
      {/* Form - keeping same structure but with loading states */}
      {isCreating && (
        <Card>
          <CardHeader>
            <CardTitle>{editingId ? 'Modifier' : 'Créer'} une tâche</CardTitle>
          ...
          <CardContent className="space-y-6">
            {/* Same form content as before but with disabled states when loading */}
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <Label>Type de tâche</Label>
                <Select
            ...
            {/* Subtasks section - same as before but with loading disabled */}
            {formData.type === 'writing' && (
              <div className="border-t pt-6">
                <h3 className="text-lg font-medium mb-4">Configuration des 3 sous-tâches</h3>
                <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {/* Same questions display as before */}
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <PenTool className="h-5 w-5 text-green-600" />
